??? infusion "Ring of Spell Storing | Clothing (Jewelry)"
    ...
    Before you cast a Spell using a Spell Slot whose Level is no more than this item's remaining Charges, you can roll a **1d6**.
