??? infusion "Bag of Holding | Wondrous Item"
    ...
    If the bag is overloaded, pierced, or torn, it is destroyed and its contents are scattered to a random location in the Astral Plane.  If the bag is turned inside out, its contents spill forth unharmed.
