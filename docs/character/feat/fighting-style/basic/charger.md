...
- Before you deal damage, you can add **1d8** to the Attack's damage.
- After you deal damage, if the target is no more than one size larger than you, you can move it up to **10** feet straight away from you.