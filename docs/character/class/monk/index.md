...
|---|---|---|---|---|
|  1 | [Ki](#1-ki),<br>[Unarmored Stance](#1-unarmored-stance),<br>[Martial Arts](#1-martial-arts) | d6 | +10 ft. | 2 |
...
Before you take Physical Damage from an Attack, you can reduce that damage by **1d10 + DEX + LV**.

#### Redirect
Free Action, 1 Ki use
{ .subtitle }
...
| | |
|---|---|
| Fail | You deal **2 × Martial Arts Die + DEX** damage of the original Attack's type. |
...
After your Turn ends, you can end one of Charmed, Frightened, or Sickened on yourself _(these conditions can't prevent using this feature)_.
