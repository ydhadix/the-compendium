...
|---|---|
| [Ability Checks](check.md) | Testing an Ability against a Difficulty Class. |
| [Attack Rolls](attack.md) | Testing whether an attack hits its target. |
| [Saving Throws](save.md) | Resisting a harmful effect. |
