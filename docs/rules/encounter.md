# Encounters
An **Encounter** is any scene where timing matters.
{ .subtitle }

## Initiative
**Initiative** is the order participants in an Encounter take Turns until the Encounter is resolved.

#### Initiative Checks
When an Encounter begins, each participant makes an **Initiative Check** to set the order of Turns, from highest result to lowest.  An Initiative Check adds your Dexterity to the total.
