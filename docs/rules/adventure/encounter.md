...
### Initiative
After an Encounter begins, each participant makes an Initiative Check to set the order of Turns, from highest result to lowest.

#### Initiative Checks
An Initiative Check adds your Dexterity to the total.

#### Initiative Ties
If Initiative Checks tie, the creature with the higher Dexterity goes first. If they still tie, each tied creature rolls a d20, and the higher roll goes first.
