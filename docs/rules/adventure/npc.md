...
The feature or Spell that gives you a Companion also describes how to command it to move and act.  If you don't command a Companion, it Dodges and moves to stay within **10** feet of you, avoiding danger if it can.

While you are Incapacitated, your Companions can act and Move on their own, no longer limited to the Dodge Action.

No matter how many commands you issue, a Companion can take only one of each type of Action on its Turn.
...
You can use a Free Action to switch between your own senses and your familiar's.

#### Dismiss / Resummon
You can use a Magic Action to temporarily dismiss the familiar to a pocket dimension or cause it to reappear within **30** feet of you.
...
You command your mount to move and Dash, Disengage, or Dodge.
