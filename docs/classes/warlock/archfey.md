...
--8<-- "classes/warlock/_features/table.md"

| Level | Subclass Features |
|---|---|
| 3 | archfey spells beguiling defense steps of the fey |
| 6 | misty escape |
| 9 | bewitching magic |

--8<-- "classes/warlock/_features/overview.md"

## Class Features

--8<-- "classes/warlock/_features/level-1.md"
