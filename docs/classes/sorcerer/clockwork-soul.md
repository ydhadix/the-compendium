...
--8<-- "classes/sorcerer/_features/table.md"

| Level | Subclass Features |
|---|---|
| 3 | clockwork soul spells restore balance trance of order |
| 6 | bastion of law |
| 9 | clockwork cavalcade |

--8<-- "classes/sorcerer/_features/overview.md"

## Class Features

--8<-- "classes/sorcerer/_features/level-1.md"
