...
After the attack, each target within **10** feet of the target then makes a Reflex Save.

| | |
|---|---|
| Fail | You deal **2d8** Lightning Damage. |
| Success | You deal half as much damage. |

##### At Higher Levels
Add **1d8** damage to both effects per additional Spell Level.
