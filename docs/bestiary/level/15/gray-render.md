# Gray Render
**Gray Renders** are hulking, six-eyed brutes that fixate on a single creature and defend it with lethal devotion, whether or not that creature wants a guardian. Everything else within reach is treated as a threat to it.
{ .subtitle }
...
| Features | |
|---|---|
| Multiattack | The gray render makes one Bite attack and **2** Claw attacks. |
