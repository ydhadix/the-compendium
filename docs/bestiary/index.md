...
|---|---|---|---|
| Good | Do the right thing as expected by society. | Do the best they can, working within rules but not feeling bound by them. | Act as conscience directs, with little regard for what others expect. |
...
### Disposition
A creature's **Disposition** describes its attitude toward a **Party**; a group of Allies with collective relationships with other creatures.  A creature holds a single Disposition toward a party, and every member of that party shares it.

Relationships are shaped by a wide array of roleplaying factors, but sort into three Dispositions:

| Disposition | Behavior |
|---|---|
| Ally | Fights with or for the party, and will put itself at risk for their sake. |
| Independent | No desire to help or harm the party.  Most creatures are Independent by default. |
| Enemy | Actively antagonistic.  Combat begins when an Enemy becomes aware of the party. |
...
The feature or Spell that gives you a Companion also describes how to command it to move and act _(no matter how many commands you issue, a companion still has the normal action budget for a creature)_.  If you don't command a Companion, it Dodges and moves to stay within **10** feet of you, avoiding danger if it can.
...
You can command your mount or let it act on its own _(no matter how many commands you issue, a mount still has the normal action budget for a creature)_.  An uncommanded mount moves and acts as it wishes, and has no restrictions on its Action.

An intelligent mount decides whether it allows itself to be commanded, and may refuse commands it disagrees with.
