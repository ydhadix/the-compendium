### Frostburn Weapon
Very Rare Weapon (Thrown)
{ .subtitle }

This weapon emits Bright Light out to **20** feet and Dim Light **20** feet further, and after a Ranged Attack using this weapon hits or misses, it returns to your hand.
