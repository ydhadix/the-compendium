...
| | |
|---|---|
| Fail | You knock the target Prone. |
| Success | No effect. |
...
| | |
|---|---|
| Fail | You knock the target Prone, and it makes a Concentration Save _(DC **17**)_. |
| Success | No effect. |

You can also open a **30**-foot-deep, **10**-foot-wide fissure anywhere in the area.  Everything on that spot makes a Reflex Save _(DC **17**)_.

| | |
|---|---|
| Fail | The target falls into the fissure. |
| Success | The target moves with the fissure's edge. |

Any structure on that spot collapses into the fissure.
