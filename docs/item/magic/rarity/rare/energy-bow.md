...
| | |
|---|---|
| Fail | You restrain the target for **1** minute. |
| Success | No effect. |

###### Break Free
Any creature Restrained this way can take this Action.

**Magic Action:** The creature makes an Athletics Check _(DC **20**)_.  On a success, this effect ends on it.
