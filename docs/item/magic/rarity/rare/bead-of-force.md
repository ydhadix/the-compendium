...
| | |
|---|---|
| Fail | You deal **5d4** Force Damage to the target, trapping it if it is entirely inside the Sphere. |
| Success | No effect, and you propel the target out of the Sphere. |
