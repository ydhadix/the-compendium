...
##### Command Word
**Magic Action:** You can speak **1** of the following Command Words to use its effect.  Once the gem's last use is expended, it becomes a nonmagical gem worth **50** gold.

| Command | |
|---|---|
| Illuminate | This item gains the effect of _Light_ for **1** hour, or until you speak this Command Word again. |
