...
| | |
|---|---|
| Hit | You deal **2d10** Force Damage and push the target up to **5** feet away. |

Increase the Force Damage by **2d10** and the push distance by **5** feet for each additional Charge expended.
