...
|---|---|---|---|---|---|---|---|
| death | medicine, religion | dancing lights, false life | gentle repose | animate dead | death ward | create undead | cleric |
| detection | perception, stealth | message, find familiar | detect thoughts | clairvoyance | arcane eye | scrying | wizard |
| finding | perception, survival | light, hunter's mark | locate object | locate creature | psychic lance | hold monster | druid |
| handling | nature, survival | produce flame, animal friendship | find steed | conjure animals | dominate beast | awaken | druid |
| healing | athletics, medicine | spare the dying, cure wounds | lesser restoration | aura of vitality | aura of life | greater restoration | cleric |
| hospitality | insight, persuasion | friends, goodberry | prayer of healing | tiny hut | aura of purity | heroes' feast | cleric |
| making | arcana, an artisan's tool | mending, identify | magic weapon | elemental weapon | fabricate | creation | wizard |
| passage | acrobatics, survival | message, expeditious retreat | misty step | haste | dimension door | teleportation circle | wizard |
| scribing | history, precision | mage hand, comprehend languages | silence | tongues | private sanctum | legend lore | wizard |
| sentinels | athletics, perception | blade ward, compelled duel | knock | counterspell | resilient sphere | arcane hand | cleric |
| shadows | deception, performance | minor illusion, disguise self | invisibility | major image | greater invisibility | mislead | bard |
...
Greater Dragonmark boons require another Dragonmark as a prerequisite. Each also grants the Greater Mark Spellcasting feature.

### Greater Mark Spellcasting

You gain an additional spell slot whose level increases with your Character Level. When you finish a Long Rest, you regain this spell slot.
