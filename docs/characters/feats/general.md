...
??? feats "Actor | 2 Charisma"
    ...
    ###### Mimicry
    You can mimic the sounds of another creature. A creature that can hear you can make a DC **[8 + CHA + PB]** Insight check _(no action required)_.
...
??? feats "Inspiring Leader | 2 Intelligence, Wisdom, or Charisma"
    ...
    After a Short Rest, you can choose up to **6** creatures _(including yourself)_ within **30** feet. Each target gains **[LV + INT, WIS, or CHA]** Temporary Hit Points.
...
??? feats "Poisoner | —"
    ...
    ###### Poisoner's Kit
    You gain Proficiency with the Poisoner's Kit. If you already have Proficiency, you can gain Expertise instead.
    ...
    | | |
    |---|---|
    | **Fail** | You deal **2d8** Poison Damage. The target is Poisoned until the end of your next Turn. |
    | **Success** | No effect. |
...
??? feats "Scion of Chaos | Chaotic alignment, no Scion Feat"
    ...
    | d4 | Effect |
    |---|---|
    | 1 | **Battle Fury** — Choose one creature within **60** feet. It has Advantage on Attack Rolls and Disadvantage on Ability Checks. |
...
??? feats "Scion of Scorn | Evil alignment, no Scion Feat"
    ...
    Before you deal damage to a creature within **60** feet, you can add **[1d6 + PB]** Necrotic Damage and heal by the Necrotic Damage dealt.
...
??? feats "Telekinetic | —"
    ...
    | | |
    |---|---|
    | **Fail** | The target is moved **5** feet toward or away from you. |
    | **Success** | No effect. |
...
??? feats "Telepathic | —"
    ...
    You can speak telepathically to any creature within **60** feet. Your telepathic utterances are in a language you know, and the target understands you only if it knows that language. Your communication doesn't give the target the ability to respond to you telepathically.
