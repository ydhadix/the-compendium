...
??? race "Nimble | —"
    ...
    You can move through the space of any creature that is no more than one size larger than you, but you can't stop in the same space.
...
??? race "Versatile | —"
    ...
    You gain an [Origin Feat](feats/origin.md) of your choice.
